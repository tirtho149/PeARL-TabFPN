...
\author{\IEEEauthorblockN{Udhashi Bhattacharjee\textsuperscript{1}, Alloy Das\textsuperscript{1}, Saria Hannan\textsuperscript{1}, Tirtho Roy\textsuperscript{1}, and Soumik Sarkar\textsuperscript{2,3}}
\IEEEauthorblockA{\textsuperscript{1}Iowa State University, Ames, IA\\
\textsuperscript{2}Department of Electrical and Computer Engineering, Iowa State University\\
\textsuperscript{3}Center for Biomedical AI, Iowa State University}
}
